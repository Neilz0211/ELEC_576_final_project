...
class Converter:
    def __init__(self, variant: str, decoder_variant: str, checkpoint: str, device: str):
        self.model = MattingNetwork(variant, decoder_variant=decoder_variant).eval().to(device)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--variant', type=str, required=True, choices=['mobilenetv3', 'resnet50', 'swin'])
    ...
    converter = Converter(args.variant, args.decoder_variant, args.checkpoint, args.device)
    converter.convert(
